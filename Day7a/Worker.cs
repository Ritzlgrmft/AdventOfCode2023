namespace AdventOfCode2023.Day7a;
...
public class Worker : IWorker
{
    ...
    {
        var distinctCards = hand.Distinct();
        var countOfFirstCard = hand.Where(c => c == distinctCards.First()).Count();
        switch (distinctCards.Count())
        {
            ...
            case 2:
                if (countOfFirstCard == 1 || countOfFirstCard == 4)
                {
            ...
            case 3:
                ...
                if (countOfFirstCard == 3 || countOfLastCard == 3 || countOfFirstCard == 1 && countOfLastCard == 1)
                {
